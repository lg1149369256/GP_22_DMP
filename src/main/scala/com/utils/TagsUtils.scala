...
object TagsUtils {
  val hasneedOneUserId =
    "imei!='' or mac!='' or idfa!='' or openudid!='' or androidid!='' or imeimd5!='' " +
    "or macmd5!= '' or openudidmd5!='' or idfamd5!='' or androididmd5!=''or imeisha1!='' " +
    "or macsha1!='' or idfasha1!='' or openudidsha1!='' or androididsha1!=''"
  // 过滤需要的字段
  val OneUserId =
    """
